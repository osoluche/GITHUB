	...
	public void sendErrorMail(final StringBuilder errorContent) {
		...
		new Thread() {
			...
			public void run() {
				...
				Looper.prepare();
				builder.setTitle("Notificaciones ComprendeMX");
				builder.create();
				...
				builder.setMessage("Esta función fue desabilitada, regresaras a la pantalla anterior.");
				//se cerrará el plan de clase actual
				builder.show();
				Looper.loop();
			}
		}.start();
