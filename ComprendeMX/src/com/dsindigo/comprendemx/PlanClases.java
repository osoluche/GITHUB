...
public class PlanClases extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		db.abrir();
		Cursor c = db.obtenerPlanes();
		if (c.moveToFirst()){
			do {
				
				final TableRow tableRows = new TableRow(this);
				tableRows.setTag(c.getString(0));
		        ...
		        newText.setText(c.getString(1).trim());
		        ...
		        final TextView fechacs = new TextView(this);
		        fechacs.setText(c.getString(2));
		        fechacs.setTextColor(Color.WHITE);
		        fechacs.setGravity(Gravity.RIGHT);
		        fechacs.setWidth(100);
		        ...
		        tableRows.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						ConectorSQL udx = new ConectorSQL(getBaseContext());
						udx.abrir();
						udx.visitarplan(idcat);
						udx.cerrar();
						
						Intent i = new Intent(v.getContext(), MainActivity.class);
						i.putExtra("currentMenu", "PlanClases");
						i.putExtra("currentPlan", idcat);
						i.putExtra("signatureid", idcat);
						startActivity(i);
					}
		        });
