...
public class LiberarEspacio extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_liberarespacio);
		...
		new AlertDialog.Builder(this)
				.setMessage(
						"Esta acción eliminará los planes de clase y evaluaciones guardadas en la tableta, ¿Deseas continuar?")
	...
	public void iniciarBorrado() {
		...
		File carpetaMx = new File(Environment.getExternalStorageDirectory()
				+ File.separator + "ComprendeMX");

		if (carpetaMx.exists()) {

			try {
				FileUtils.deleteDirectory(carpetaMx);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}

			final TableRow tableRows2 = new TableRow(this);
			tableRows2.setPadding(0, 5, 0, 5);
			tableRows2.setLayoutParams(new TableLayout.LayoutParams(
					LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
			tableRows2.setBackgroundResource(R.drawable.ic_bottomline);

			final TextView dtx = new TextView(this);
			dtx.setText("Liberado espacio en disco ...");
			dtx.setTextColor(Color.rgb(255, 255, 255));
			dtx.setTextSize(getRequestedOrientation());
			dtx.setGravity(Gravity.LEFT);
			dtx.setLayoutParams(new TableRow.LayoutParams(
					LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
			dtx.setPadding(5, 15, 0, 0);

			final ImageView dtximg = new ImageView(this);
			dtximg.setImageResource(R.drawable.ic_ok_answer);
			dtximg.setPadding(5, 10, 0, 0);

			tableRows2.addView(dtximg);
			tableRows2.addView(dtx);
			tablaPlanes.addView(tableRows2);

			// Borrado de la db
			ConectorSQL dbx = new ConectorSQL(getBaseContext());
			dbx.abrir();
			dbx.borrarTabla("planes");
			dbx.borrarTabla("evaluaciones");
			dbx.cerrar();

			final TableRow tableRows3 = new TableRow(this);
			tableRows3.setPadding(0, 5, 0, 5);
			tableRows3.setLayoutParams(new TableLayout.LayoutParams(
					LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
			tableRows3.setBackgroundResource(R.drawable.ic_bottomline);

			final TextView dbtx = new TextView(this);
			dbtx.setText("Liberado espacio en la base de datos ...");
			dbtx.setTextColor(Color.rgb(255, 255, 255));
			dbtx.setTextSize(getRequestedOrientation());
			dbtx.setGravity(Gravity.LEFT);
			dbtx.setLayoutParams(new TableRow.LayoutParams(
					LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
			dbtx.setPadding(5, 15, 0, 0);

			final ImageView dbtximg = new ImageView(this);
			dbtximg.setImageResource(R.drawable.ic_ok_answer);
			dbtximg.setPadding(5, 10, 0, 0);

			tableRows3.addView(dbtximg);
			tableRows3.addView(dbtx);
			tablaPlanes.addView(tableRows3);
		} else {
			Log.d("logmx ", "Not found => " + carpetaMx.toString());
		}

		final TableRow tableRows4 = new TableRow(this);
		tableRows4.setPadding(0, 5, 0, 5);
		tableRows4.setLayoutParams(new TableLayout.LayoutParams(
				LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
		tableRows4.setBackgroundResource(R.drawable.ic_bottomline);

		final TextView dbtx2 = new TextView(this);
		dbtx2.setText("Se ha terminado de liberar espacio en la aplicación, sera necesario actualizes de nuevo para obtener el contenido mas reciente; ");
		dbtx2.setTextColor(Color.rgb(255, 255, 255));
		dbtx2.setTextSize(getRequestedOrientation());
		dbtx2.setGravity(Gravity.LEFT);
		dbtx2.setLayoutParams(new TableRow.LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		dbtx2.setPadding(5, 15, 0, 0);

		final ImageView dbtximg2 = new ImageView(this);
		dbtximg2.setImageResource(R.drawable.ic_ok_answer);
		dbtximg2.setPadding(5, 10, 0, 0);

		tableRows4.addView(dbtximg2);
		tableRows4.addView(dbtx2);
		tablaPlanes.addView(tableRows4);
	}
	...
	private class ConexionBackend extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String app) {
			...
			SyncEvaluaciones sev = new SyncEvaluaciones();
			sev.execute();
		}
	}
